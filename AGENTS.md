...
# Run all tests (396 total, no linter/formatter configured)
...
- Current counts: test_ai (105), test_collector (74), test_parser (46), test_decision (27), test_audit (29), test_filter (26), test_human_review (23), test_analytics (22), test_profile (19), test_ai_scoring (10), test_preferences (10), test_review_ui (5) → 396 total. Reset the exact counts from the real file (`tests/baseline/baseline_tests.txt`) when editing them; the summary here is indicative.
