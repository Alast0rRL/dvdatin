...
- Current counts: test_ai (114), test_collector (99), test_parser (47), test_decision (28), test_audit (29), test_filter (26), test_human_review (23), test_analytics (22), test_profile (19), test_ai_scoring (10), test_preferences (10), test_review_ui (5), test_auto_action (36), test_auto_action_audit (4), test_control_bot (12) → 484 total. Reset the exact counts from the real file (`tests/baseline/baseline_tests.txt`) when editing them; the summary here is indicative.
